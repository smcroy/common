...
namespace qs.Extensions.FloatExtensions
{
    public static class FloatExtensions
    {
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        public static int Ceiling(this float a)
        {
            return (int)Math.Ceiling(a);
        }

        /// <summary>
        /// Compares this instance with another instance of nullable System.Float.
        /// </summary>
        /// <param path="a">Instance of type nullable System.Float to use in the comparison.</param>
        /// <param path="a">A comparand of type nullable System.Float.</param>
        ...
        /// </summary>
        /// <param name="a">Instance of type System.Float.</param>
        /// <returns>Returns the result of rounding the floating-point value as a float.</returns>
        ...
        /// <returns></returns>
        public static float Round(this float a, int digits)
        {
            return (float)Math.Round(a, digits, MidpointRounding.AwayFromZero);
        }
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        public static float RoundAsCurrency(this float a)
        {
            return (float)Math.Round(a, CultureInfo.CurrentCulture.NumberFormat.CurrencyDecimalDigits, MidpointRounding.AwayFromZero);
        }

        /// <summary>
        /// Returns the absolute value of a specified Float.
        /// </summary>
        /// <param name="a">Instance of type System.Float.</param>
        ...
        /// <summary>
        /// Returns the float formatted corresponding to the current culture currency decimal digits.
        /// </summary>
        /// <param name="a"></param>
        /// <returns></returns>
        public static string ToCurrencyFormat(this float a)
        {
            return string.Format(CurrencyFormat, a);
        }

        /// <summary>
        /// Returns the float formatted corresponding to the current culture currency decimal digits with separators.
        /// </summary>
        /// <param name="a"></param>
        /// <returns></returns>
        public static string ToCurrencyFormatWithSeparators(this float a)
        {
            return string.Format(CurrencyFormatWithSeparators, a);
        }

        public static decimal ToDecimal(this float a)
        {
            return Convert.ToDecimal(a);
        }

        /// <summary>
        /// Returns a double from an instance of type nullable System.Float.
        /// </summary>
        /// <param name="a">Instance of type nullable System.Float.</param>
        /// <returns>If the nullable float has a value, then returns the value as a float; otherwise returns 0.</returns>
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        public static float ToFloat(this float? a)
        {
            return a ?? 0;
        }
        ...
        public static short ToInt16(this float a)
        {
            if (a < short.MinValue || a > short.MaxValue)
                throw new OverflowException(string.Format("Float '{0}' can not be cast as an Int16.", a));
            else
        ...
        public static int ToInt32(this float a)
        {
            if (a < int.MinValue || a > int.MaxValue)
                throw new OverflowException(string.Format("Float '{0}' can not be cast as an Int32.", a));
            else
        ...
        public static long ToInt64(this float a)
        {
            if (a < long.MinValue || a > long.MaxValue)
                throw new OverflowException(string.Format("Float '{0}' can not be cast as an Int64.", a));
            else
